...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '🎉你好，欢迎来到我的个人博客🎉, 🎉Nice to meet you🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yyzzl', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '个人研究方向：空间激光通信', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yuzhili.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'qqwss0328@gmail.com', // 邮箱地址 例如mail@tangly1024.com
